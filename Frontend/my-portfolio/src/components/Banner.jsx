    ...
    <div className="flex flex-col md:flex-row items-center justify-around bg-gradient-to-r from-blue-100 to-purple-200 dark:from-gray-700 dark:to-gray-900 p-10 rounded-2xl shadow-lg h-auto md:h-[600px]">
      ...
      <div className="flex flex-col items-center md:items-start gap-8">
        ...
        <div className="flex flex-row gap-6">
          <Button variant="outline" className="bg-orange-500 hover:bg-orange-600 text-white dark:bg-orange-500 dark:hover:bg-orange-600">
            Hire Me
          </Button>
          <Button variant="outline" className="bg-blue-500 hover:bg-blue-600 text-white dark:bg-blue-500 dark:hover:bg-blue-600">
            Download Resume
          </Button>
        </div>
      </div>
